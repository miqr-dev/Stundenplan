        ...
        <div class="bg-gray-100 overflow-hidden sm:rounded-lg">
          ...
          >
            <div class="sm:flex flex items-center justify-between">
              <h2 class="text-h2">Subjects</h2>
              <Link :href="route('subject.create')" class="text-blue-500 text-p"
                >Add a Subject</Link
              >
              <input v-model="search" type="text" placeholder="search..." class="rounded-xl px-2">
            </div>
